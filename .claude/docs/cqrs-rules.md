...
> **Что это.** Сжатый индекс правил `cqrs-style-guide.md`: код + формулировка, по разделам. Рабочий вход
> для скиллов — review цитирует код, design сверяется по чек-листу. **Полная версия с примерами, code-блоками,
> обоснованием и под-пунктами — `cqrs-style-guide.md`**; открывай её точечно по нужному разделу.
