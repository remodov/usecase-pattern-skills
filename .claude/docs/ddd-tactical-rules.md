# DDD Tactical Patterns — индекс правил

> **Что это.** Сжатый индекс правил `ddd-tactical-style-guide.md`: код + формулировка (заголовок правила
> + первая строка пояснения). Рабочий вход скиллов. **Полная версия с примерами и обоснованием —
> `ddd-tactical-style-guide.md`**; открывай её точечно по нужному разделу.
