...
[`ddd-building-blocks`](https://github.com/remodov/ddd-building-blocks)
(пакет `ru.vikulinva.ddd`).

Этот документ — единственный источник правды для скиллов
`ucp-ddd-tactical-review` и `ucp-ddd-tactical-design`. Любые расхождения с этим
гайдом — нарушение, требующее исправления или явного отступления с
комментарием в коде.

Полная версия с примерами и обоснованиями: <https://vikulin-va.ru/domain-driven-design/tactical-patterns/>.
