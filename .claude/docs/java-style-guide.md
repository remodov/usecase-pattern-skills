...
### `JS-7.5` Javadoc — только публичный API библиотеки или нетривиальный публичный контракт

Не пишем 4-строчный Javadoc на каждый getter / handler / controller — этот шум хуже отсутствия документации.
