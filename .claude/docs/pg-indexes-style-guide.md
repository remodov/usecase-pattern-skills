...
Полная версия с примерами и `EXPLAIN`-выводами:
- <https://vikulin-va.ru/pg/indexes-composite/>
- <https://vikulin-va.ru/pg/indexes-types/>
- <https://vikulin-va.ru/pg/indexes-selectivity/>
- <https://vikulin-va.ru/pg/explain/>
