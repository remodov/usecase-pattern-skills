...
- Парные документы: `rest-api-rules.md` (`R-API-ERR-*`), `validation-rules.md` (`R-VLD-*`), `resilience-rules.md` (`R-RES-RE-*`/`R-RES-FB-*`), `auth-patterns-style-guide.md` (`AUTH-18`/`AUTH-19`), `observability-rules.md` (`R-OBS-LOG-*`).
