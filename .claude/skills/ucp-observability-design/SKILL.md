...
1. **Прочитай** `.claude/docs/observability-rules.md` (`R-OBS-*`). Опционально — `auth-patterns-style-guide.md` (`AUTH-16` PII), `rest-api-rules.md` (`R-HDR-4` traceparent), `validation-rules.md` (`R-VLD-CFG-*`).
