...
1. **Прочитай** `.claude/docs/validation-rules.md` — главный (`R-VLD-*`). Опционально `.claude/docs/rest-api-rules.md` `R-ERR-5`/`R-ERR-6` для понимания, как ошибка попадёт в violations.
